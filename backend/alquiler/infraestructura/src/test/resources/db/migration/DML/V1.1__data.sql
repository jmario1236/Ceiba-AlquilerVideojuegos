...
insert into cliente (id,identificacion, nombre,apellido,telefono,direccion) values (4,'114456333', 'Zuley','Barrera','xxx69852','Centro');
...
insert into alquiler (id,id_cliente, fecha_alquiler,fecha_maxima_entrega,fecha_entrega,estado, total, subtotal, total_adicional, total_multa) 
values (2,4, '2020-11-7','2020-11-10',null,'VIGENTE', 6000, 6000,0,0);
